...
public class updateProductController implements Controller {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response) {
			...
			if(mDao.updateProduct(id,name,price,desc,category,stock,imgsrc,like,dislike,view)) 
			{

				return"./adminPopup/updateSuccess_product";

			}else{
				
				return"./adminPopup/updateFail_product"; 
			}
