...
<body>
		...
		<table class="poly_table"
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="/Chicken/postRead.do?board_no=<%=noticeText.getNumber()%>&board=<%="event"%>"><%=noticeText.getTitle()%></a></td>
	...
	%>
	<div
		style="margin: 0 auto; width: 830px; text-align: center; margin-bottom: 30px;">
		<span
			style="color: black; background-color: transparent; font-size: 30px">
