...
<nav class = "navbar navbar-expand  navbar-dark bg-dark">
	...
	<div class="container" style="max-width:830px">
		<form action="/Chicken/reviewUpdate.do?writeNo=<%=rDto.getNo() %>" class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<label class="col-sm-4">리뷰 제목</label>
				<div class="col-sm-12">
					<input type="text" cols="150" name="write_title" id="write_title" class="form-control" value="<%=rDto.getTitle() %>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-12">
					<textarea id="write_content" name="write_content" cols="150" rows="10" class="form-control"><%=rDto.getContent() %></textarea>
				</div>
			</div>
			<div>
