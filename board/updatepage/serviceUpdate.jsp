...
<nav class = "navbar navbar-expand  navbar-dark bg-dark">
	...
	<div class="container" style="max-width:830px">
		<form action="/Chicken/serviceUpdate.do" class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<label class="col-sm-4">문의사항</label>
				<div class="col-sm-12">
					<input type="text" cols="150" name="write_title" id="write_title" class="form-control" value="<%=sDto.getTitle()%>">
				</div>
			</div>
			
			<div class="form-group row">
				<label class="col-sm-4">문의 내용</label>
				<div class="col-sm-12">
					<textarea id="write_content" name="write_content" cols="150" rows="10" class="form-control"><%=sDto.getContent() %></textarea>
				</div>
			</div>
			...
			<div class="form-group row">
				<label class="col-sm-12" style="margin-left:70px; line-height: 42px; color:gray;">선택된 이미지가 없을 경우 기존 이미지가 유지됩니다.</label>
			</div>
			<div class="form-group row">
