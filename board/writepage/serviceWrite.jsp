...
<nav class = "navbar navbar-expand  navbar-dark bg-dark">
	...
	<div class="container" style="max-width:830px">
		<form action="/Chicken/serviceWrite.do" class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<label class="col-sm-4">문의사항</label>
				<div class="col-sm-12">
					<input type="text" cols="150" name="write_title" id="write_title" class="form-control">
				</div>
			</div>
