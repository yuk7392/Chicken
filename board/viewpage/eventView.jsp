...
<body>
<%	
boardDto eDto = (boardDto)session.getAttribute("readDto"); 
%>
...
<nav class = "navbar navbar-expand  navbar-dark bg-dark">
	...
	<div class="container" style="max-width:830px; margin-top:10px;">
			...
			<div class="form-group row" style="margin-bottom:0">
				<label id="read_title" class="col-sm-9"><%=eDto.getTitle() %></label>
				<label class="col-sm-1" style="white-space:pre; color:#495057">글쓴이: <%=eDto.getWriter() %></label>
			</div>
	...
	<hr style="margin-top:5px; margin-bottom:15px; width:820px">
			...
			<div class="col-sm-12" style="white-space:pre-line; width:830px; margin-bottom:30px;"><%=eDto.getContent() %></div>
	<hr>
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-12">
					<div style="margin:0 auto; width:90px;">
						<a href="/Chicken/list.do?boardName=<%="event"%>"><input type="button" class="btn btn-primary" Value="목록으로"></a>
					</div>
				</div>
			</div>
	</div>
