			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-12">
					<div style="margin:0 auto; width:270px;">
						<a href="/Chicken/list.do?boardName=<%="service"%>"><input type="button" class="btn btn-primary" Value="목록으로"></a>
						<%
						String mem = (String)session.getAttribute("idKey");
						if(mem != null)
							  if(mem.equals(sDto.getWriter()))
							  {	%>
							<a href="/Chicken/board/updatepage/serviceUpdate.jsp"><input type="button" class="btn btn-primary" value="수정하기"></a>
